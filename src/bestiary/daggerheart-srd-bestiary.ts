  ...
  },
  {
    ...
    feats: [
      ...
      },
      {
        ...
        text: "When the Scourge takes Major damage, roll d10. On 8+, erupt lava in Very Close range: Agility Reaction Roll or take 2d10+4 physical damage, mark 1d4 Stress, and are Vulnerable until clearing a Stress; success = half damage + mark a Stress."
      },
      {
        id: "lDWqedvo6eBQloYYAb2hj",
        name: "Lava Splash - Reaction",
        text: "When the Scourge takes Severe damage from attack within Very Close, molten blood deals 2d10+4 direct physical damage to attacker."
      },
      {
        id: "H6mXE3fFtUL6hr7nVo0wV",
        name: "Ashen Vengeance (Phase Change) - Reaction",
        text: "When the Scourge marks last HP, replace with Ashen Tyrant and immediately spotlight."
      }
    ]
  },
  {
